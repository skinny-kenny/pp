...
$sql = "SELECT id, name, surname, patronymic, phone_number, id_product, quantity_product FROM clients";
...
<div class="wrapper">
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td data-label='Номер телефона'>".$row["phone_number"]."</td>";
                echo "<td data-label='ID товара'>".$row["id_product"]."</td>";
                echo "<td data-label='Количество товара'>".$row["quantity_product"]."</td>";
                echo "<td data-label='Действия'>
                    <div class='actions'>
                        ...
                        <a href='edit_clients.php?id=".$row["id"]."'>Изменить</a>
                        </div>
                      </td>";
                echo "</tr>";
            }
    ...
    <p><a href="add_client.php">Добавить нового клиента</a></p>
    </div>
    </div>
</body>
</html>
